...
ActiveRecord::Schema.define(version: 2023_05_05_102807) do
  ...
  create_table "disco_app_flow_trigger_usages", force: :cascade do |t|
    t.bigint "shop_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_id", "flow_trigger_definition_id"], name: "index_disco_app_flow_actions_on_shop_id_and_trigger_id", unique: true
  end
